...
pd.DataFrame({"population_id": truth, "python_angular_k20_fast_hnsw_cached": labels}).to_csv(out_dir / "python_samusik01_full_fast_hnsw_cached_labels.csv", index=False)
summary = pd.DataFrame([{
    "run": "python_angular_k20_full_fast_hnsw_cached",
    "n_cells": len(labels),
...
summary.to_csv(out_dir / "python_samusik01_full_fast_hnsw_cached_metrics.csv", index=False)
