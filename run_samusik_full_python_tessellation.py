...
pd.DataFrame({"population_id": truth, "python_angular_k20_tessellation": labels}).to_csv(out_dir / "python_samusik01_full_tessellation_labels.csv", index=False)
summary = pd.DataFrame([{
    "run": "python_angular_k20_full_tessellation",
    "n_cells": len(labels),
...
summary.to_csv(out_dir / "python_samusik01_full_tessellation_metrics.csv", index=False)
